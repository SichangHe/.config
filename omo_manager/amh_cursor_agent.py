...
def parse_args(argv: list[str]) -> Args:
    ...
    parser.add_argument("--model", required=True, help="Cursor model family without an effort suffix, such as gpt-5.6-terra.")
    parser.add_argument("--reasoning-effort", required=True, choices=EFFORTS, help="Cursor model effort suffix.")
