...
- pending ref semantics
  ...
  - delivered blocked-task classifications are keyed by task/TODO identity, blocker, queue, owner, and stable pane identity in a private durable ledger; watcher restarts and changed group problem IDs stay quiet until that evidence changes
