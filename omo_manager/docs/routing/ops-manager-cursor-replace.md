...
- caller confirmation matches the pinned task, target, and human source: `--task-file ops_manager.md`, `--target wl:3` or `wl:3.0`, `--authority-file manager_mail/85c5dff58359-741.txt`, `--authority-lines 16-16`
