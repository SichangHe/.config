...
1. finds exactly one live supported Codex launch argv below the pane PID, accepting `@openai/codex@0.155.1`, an existing `@openai/codex@latest`, or a legacy `@openai/codex` process;
...
6. starts `bunx @openai/codex@0.155.1 --dangerously-bypass-approvals-and-sandbox` with explicit model, effort, and the composed initial prompt;
