...
- reauthenticate the audit and pane identity inside the child before killing the numeric pane
- retain the commitment-bound close proof beside the audit
...
- reject missing proof, rebound identity, changed capture, changed task or TODO, competing ownership, malformed audit, or an out-of-order task suffix

boundaries

- do not use this mode for running, blocked, queued, manager, v2, Cursor, PCODX, or human-owned tasks
- do not delete the completed audit or its sibling `.owner-stopped` proof
